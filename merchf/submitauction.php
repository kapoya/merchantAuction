...
$startauction = "INSERT INTO `auction` (`item_ID`, `date_started`, `date_deadline`, `starting_bid`, `buyout`) VALUES ( '{$newitemid['id']}', CURRENT_TIME(), '{$_POST['deadline']}', '{$_POST['startbid']}', '{$_POST['buyout']}')";
