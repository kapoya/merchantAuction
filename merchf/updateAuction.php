...
$updateauctionitem = "UPDATE auction JOIN auction_item ON item_ID = auction_item.ID  SET name = '{$_POST['aiName']}', type = '{$_POST['type']}', 	item_condition = '{$_POST['iCondition']}', buyout = '{$_POST['buyout']}' ";

if(isset($target_file)){ 
	$updateauctionitem.= ", image = '{$target_file}'";
}	

$updateauctionitem.= "WHERE auction.ID = '{$_GET['id']}'";
